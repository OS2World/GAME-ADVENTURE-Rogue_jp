...
#ifdef JAPAN
char *left_or_right = "左手(L)、それとも右手(R)？";
char *no_ring = "そちらの手には指輪をしていない。";
#else
...
#ifdef JAPAN
	if ((ch = pack_letter("どの指輪を？", RING)) == CANCEL) {
#else
